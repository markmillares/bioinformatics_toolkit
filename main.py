...
# print(test_dna_2.reverse_complement())

test_dna = BioSeq.generate_random_seq()
print(test_dna.get_seq_info())
print(test_dna.dna_complement())
print(test_dna.dna_reverse_complement())
print(test_dna.gc_content())
print(test_dna.gc_content_subsec())
print(test_dna.translate_sequence())
# print(test_dna.codon_usage("L"))

for rf in test_dna.reading_frames():
    print(rf)

print(test_dna.proteins_from_all_orfs())

current = [""]

print(range(len(current)))
